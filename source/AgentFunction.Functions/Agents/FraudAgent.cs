...
public sealed class FraudAgent(Kernel kernel, ILogger<FraudAgent> logger) :
                    AgentBase<CanonicalClaim, FraudResult>(
                        kernel,
                        logger,
                        name: "FraudAgent",
                        instructions: """
...
{
    private readonly ILogger<FraudAgent> _typedLogger = logger ?? throw new ArgumentNullException(nameof(logger));
